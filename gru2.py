...
model.add(GRU(num_appliances, dropout=0.2, recurrent_dropout=0.2, input_shape=(1,2), return_sequences=True, activation='sigmoid' ))
model.add(GRU(num_appliances, input_shape=(1,2), return_sequences=True, activation='sigmoid' ))
model.add(GRU(num_appliances, input_shape=(1,2), return_sequences=True, activation='sigmoid' ))
