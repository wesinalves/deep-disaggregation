...
model.add(LSTM(n_dim, dropout=0.2, recurrent_dropout=0.2, input_shape=(1,n_dim), return_sequences=True, activation='sigmoid' ))
model.add(LSTM(n_dim, input_shape=(1,n_dim), return_sequences=True, activation='sigmoid' ))
model.add(LSTM(n_dim, input_shape=(1,n_dim), return_sequences=True, activation='sigmoid' ))
model.add(LSTM(n_dim, input_shape=(1,n_dim), return_sequences=True, activation='sigmoid' ))
model.add(LSTM(n_dim, input_shape=(1,n_dim), return_sequences=True, activation='sigmoid' ))
